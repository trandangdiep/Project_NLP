...
# Load files
#LOAD POSITIVE_VN
file = open('file/positive_VN.txt', 'r', encoding="utf8")
positive_VN_lst = file.read().split('\n')
file.close()
#-------------------------------------------------
#LOAD NEGATIVE_VN
file = open('file/negative_VN.txt', 'r', encoding="utf8")
negative_VN_lst = file.read().split('\n')
file.close()
#-------------------------------------------------
#LOAD POSITIVE_EMOjiS
file = open('file/positive_emojis.txt', 'r', encoding="utf8")
positive_emojis_lst = file.read().split('\n')
file.close()
#------------------------------------------------
#LOAD NEGATIVE_EMOJIS
file = open('file/negative_emojis.txt', 'r', encoding="utf8")
...
if choice == 'Business Objective':    
    ...
    st.image("images/train_rf.png",width=1200)

    st.write("##### 4. Evaluation")
    st.write("Time train : 9.44s với tập dữ liệu 16539 dòng")
    st.write("Time test : 0.22s với tập dữ liệu 4135 dòng")
    ...
    lines = None
    type = st.radio("Upload data or Input data?", options=("Upload", "Input","upload and by product"))
    flag = False
    if type=="Upload":
        # Upload file
